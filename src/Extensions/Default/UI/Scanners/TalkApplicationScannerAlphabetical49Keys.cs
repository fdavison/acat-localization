////////////////////////////////////////////////////////////////////////////
// <copyright file="TalkApplicationScannerAlphabetical_ptBR.cs" company="Intel Corporation">
//
...
namespace ACAT.Extensions.Default.UI.Scanners
{
    ...
    /// </summary>
    [DescriptorAttribute("04E9F272-0DAA-4BBD-910C-E030DD03DE55",
                        "TalkApplicationScannerAlphabetical49Keys",
                        "Talk window application with with Alphabetic keyboard layout")]
    public partial class TalkApplicationScannerAlphabetical49Keys : Form, IScannerPanel, ISupportsStatusBar, IScannerPreview
    {
        /// <summary>
        /// Number of phrases to display in the phrase list
        /// </summary>
        private const int PhraseCount = 7;
        ...
        /// </summary>
        public TalkApplicationScannerAlphabetical49Keys()
        {
            InitializeComponent();
        ...
        private class CommandHandler : RunCommandHandler
        {
            ...
            public override bool Execute(ref bool handled)
            {
                ...
                var form = Dispatcher.Scanner.Form as TalkApplicationScannerAlphabetical49Keys;
