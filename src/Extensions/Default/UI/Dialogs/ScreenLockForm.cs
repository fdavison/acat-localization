...
namespace ACAT.Extensions.Default.UI.Dialogs
{
    ...
    public partial class ScreenLockForm : Form, IPanel
    {
        ...
        private static String DefaultDateFormat = CultureInfo.CurrentUICulture.DateTimeFormat.LongDatePattern;

        /// <summary>
        /// Default format of the time to display on the form
        /// </summary>
        //private const String DefaultTimeFormat = "h:mm:ss tt";
        private static String DefaultTimeFormat = CultureInfo.CurrentUICulture.DateTimeFormat.LongTimePattern;
